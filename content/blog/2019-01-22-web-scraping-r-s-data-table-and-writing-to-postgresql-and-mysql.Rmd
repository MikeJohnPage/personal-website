...
```{r, echo = FALSE, fig.cap="Most common words of films beginning with the letter 's'."}
knitr::include_graphics("/home/mike/Downloads/plot_1.png")
```
...
```{r, echo = FALSE, fig.cap="Most common words in Star Trek."}
knitr::include_graphics("/home/mike/Downloads/plot_2.png")
```
