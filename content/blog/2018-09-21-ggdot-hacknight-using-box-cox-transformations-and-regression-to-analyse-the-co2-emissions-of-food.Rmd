...
Consequently a number for variables from the *individual_food_info* data set were selected including (i) the CO2 emissions of individually recorded meals (*CO2e*), (ii) participant age (*Age*), (iii) the day on which meals were recorded (*DayNo*), (iv) a participant identifier (*seriali*), (v) the total calories of all recorded foods on a given day (*KCALs_personday*).
